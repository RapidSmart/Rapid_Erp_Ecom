...
import { PRODUCT_PAGE_SIZES } from '../constants/product-pagination.data'
import type { ProductPaginationProps } from '../types/product.types'
...
function ProductPagination({
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 px-4 py-3">
      <div
        role="group"
        aria-label={t('product.pagination.pageSizeLabel')}
      ...
      <div className="flex items-center gap-1.5">
        <button
          ...
          aria-label={t('product.pagination.first')}
        ...
        <button
          ...
          disabled={isFirstPage}
          aria-label={t('product.pagination.previous')}
          className={navButtonClasses}
        >
        ...
        <span className="flex h-7 items-center gap-1 px-1 text-[11px] font-medium text-ink">
          ...
          {t('product.pagination.ofPages', { count: pageCount })}
        </span>
        ...
        <button
          ...
          disabled={isLastPage}
          aria-label={t('product.pagination.last')}
          className={navButtonClasses}
        >
