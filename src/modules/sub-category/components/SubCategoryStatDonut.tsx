...
import type { SubCategoryStatTone, SubCategoryStatDonutProps } from '../types/sub-category.types'
...
const toneTextClasses: Record<SubCategoryStatTone, string> = {
...
function SubCategoryStatDonut({
  ...
  actionLabel,
  onSelect,
}: SubCategoryStatDonutProps & { selected?: boolean; actionLabel?: string; onSelect?: () => void }) {
