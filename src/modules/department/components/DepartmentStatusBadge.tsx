...
import type { DepartmentStatusBadgeProps } from '../types/department.types'
...
export function DepartmentStatusBadge({ status, className }: DepartmentStatusBadgeProps) {
