...
import { DepartmentOverviewRing } from './DepartmentOverviewRing'
import type { DepartmentOverviewCardProps } from '../types/department.types'
...
function DepartmentOverviewCard({
  ...
  const content = (
    <>
      <DepartmentOverviewRing status={status} percentage={percentage} />
  ...
  return (
    <button
      ...
      aria-label={
        actionLabel ?? t('department.overview.statFilterHint', { status: label })
      }
      style={{
        ...backgroundStyle,
