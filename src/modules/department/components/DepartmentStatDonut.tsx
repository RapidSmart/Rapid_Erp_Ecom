...
import type { DepartmentStatTone, DepartmentStatDonutProps } from '../types/department.types'
...
const toneTextClasses: Record<DepartmentStatTone, string> = {
...
function DepartmentStatDonut({
  ...
  actionLabel,
  onSelect,
}: DepartmentStatDonutProps & { selected?: boolean; actionLabel?: string; onSelect?: () => void }) {
