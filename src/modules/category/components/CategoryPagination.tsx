...
import { CATEGORY_PAGE_SIZES } from '../constants/category-pagination.data'
import type { CategoryPaginationProps } from '../types/category.types'
...
function CategoryPagination({
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 px-4 py-3">
      <div
        role="group"
        aria-label={t('category.pagination.pageSizeLabel')}
      ...
      <div className="flex items-center gap-1.5">
        <button
          ...
          aria-label={t('category.pagination.first')}
        ...
        <button
          ...
          disabled={isFirstPage}
          aria-label={t('category.pagination.previous')}
          className={navButtonClasses}
        >
        ...
        <span className="flex h-7 items-center gap-1 px-1 text-[11px] font-medium text-ink">
          ...
          {t('category.pagination.ofPages', { count: pageCount })}
        </span>
        ...
        <button
          ...
          onClick={() => onPageChange(page + 1)}
          disabled={isLastPage}
          aria-label={t('category.pagination.next')}
          className={navButtonClasses}
        >
        ...
        <button
          ...
          disabled={isLastPage}
          aria-label={t('category.pagination.last')}
          className={navButtonClasses}
        >
