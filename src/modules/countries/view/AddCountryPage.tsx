  ...
  return (
    <div className="min-h-screen bg-slate-50 p-6 lg:p-8">
      <div className="mx-auto max-w-[1560px]">
        ...
        {/* Form card */}
        <article className="rounded-3xl bg-white px-8 pb-6 pt-7 shadow-sm">
          <form
            noValidate
            onSubmit={(e) => {
              e.preventDefault()
          ...
          >
            {/* IDENTITY */}
            <section aria-label={t('countries.add.sections.identity')} className="mb-6">
              <SectionHeader label={t('countries.add.sections.identity')} />
              <div className="grid grid-cols-1 gap-[30px] md:grid-cols-[1fr_2fr_1fr]">
                <PillInput
                  id="iso-code"
            ...
            >
              ...
              <div className="mt-4">
                ...
                <textarea
                  ...
                  className="w-full resize-none rounded-3xl border border-transparent bg-gray-100 px-[22px] py-[22px] text-[14.5px] text-slate-900 placeholder:text-slate-400 outline-none transition-colors focus:border-blue-400"
                />
              </div>
            </section>
