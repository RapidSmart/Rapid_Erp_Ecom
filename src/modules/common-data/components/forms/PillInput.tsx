...
import type { PillInputProps } from '../../types/common-data.types'
...
export function PillInput({
  ...
  return (
    <div className="relative h-[54px]">
      ...
      />
      {rightIcon && (
        <div className="pointer-events-none absolute right-[14px] top-1/2 -translate-y-1/2 flex items-center justify-center">
          {rightIcon}
        </div>
      )}
    </div>
