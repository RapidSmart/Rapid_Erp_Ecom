...
export default function SignIn() {
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-[#F4F5F7] font-sans p-4">
      {/*
        Standard container width: max-w-6xl (1152px).
      ...
      */}
      <div className="w-full max-w-6xl overflow-hidden rounded-[20px] bg-white shadow-[0_8px_30px_rgb(0,0,0,0.06)] grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="hidden lg:flex flex-col bg-primary p-10 lg:p-12 xl:p-14 text-white overflow-hidden">
          <div className="w-full max-w-[500px] mx-auto flex flex-col h-full justify-between">
            {/* Logo */}
            <div>
            ...
            {/* Main Content */}
            <div className="mt-16 xl:mt-20 mb-auto">
              <div className="space-y-3">
                <p className="text-sm font-medium text-white/90">
                  Complete Business Management
                </p>
                <h1 className="text-3xl lg:text-4xl tracking-tight font-bold leading-[1.1] text-white">
                  Accounting & ERP Software
                </h1>
                <p className="text-sm text-white/90 max-w-[420px] leading-relaxed pt-2">
