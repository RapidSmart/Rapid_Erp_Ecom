...
import { CountryOverviewRing } from './CountryOverviewRing'
import type { CountryOverviewCardProps } from '../types/country.types'
...
function CountryOverviewCard({
  ...
  const content = (
    <>
      <CountryOverviewRing status={status} percentage={percentage} />
  ...
  return (
    <button
      ...
      aria-label={
        actionLabel ?? t('country.overview.statFilterHint', { status: label })
      }
      style={{
        ...backgroundStyle,
